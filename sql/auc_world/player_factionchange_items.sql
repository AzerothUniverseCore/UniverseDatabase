-- Export de la table `player_factionchange_items`
SET NAMES utf8mb4;
...
CREATE TABLE `player_factionchange_items` (
  ...
  `commentA` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `race_H` int(10) unsigned NOT NULL,
  `horde_id` int(10) unsigned NOT NULL,
  `commentH` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
