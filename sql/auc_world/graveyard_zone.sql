-- Export de la table `graveyard_zone`
SET NAMES utf8mb4;
...
(1724, 5146, 0, NULL),
(1725, 5146, 0, NULL),
(1726, 50605, 0, 'Twin Peaks - Alliance Entrance'),
(1727, 50605, 0, 'Twin Peaks - Horde Entrance'),
(1728, 50605, 0, 'Twin Peaks - Horde Graveyard (Base)'),
(1729, 50605, 0, 'Twin Peaks - Alliance Graveyard (Base)'),
(1730, 361, 0, NULL),
(1731, 361, 0, NULL),
(1732, 11, 0, NULL),
(1733, 16, 0, NULL),
...
(1747, 5146, 0, NULL),
(1748, 1, 0, NULL),
(1749, 50605, 0, 'Twin Peaks - Alliance Graveyard (Center)'),
(1750, 50605, 0, 'Twin Peaks - Horde Graveyard (Center)'),
(1751, 357, 67, NULL),
(1752, 357, 469, NULL),
(1753, 25, 0, NULL),
(1754, 357, 0, NULL),
...
(1777, 148, 0, NULL),
(1778, 5146, 0, NULL),
(1780, 50600, 0, 'Netheril'),
(1782, 616, 0, 'Hyjal'),
(1784, 50603, 0, 'Netheril'),
(1785, 50604, 0, 'Netheril'),
(1788, 50624, 0, 'Firelands3'),
(1789, 50628, 0, 'Cognefort'),
(1790, 50672, 0, 'Chemin du Rêve d’émeraude'),
(1791, 50672, 0, 'Chemin du Rêve d’émeraude'),
(1792, 50639, 0, 'Sommet de Kun Lai'),
(1793, 50645, 0, 'Île du Temps figé'),
(1794, 50652, 0, 'ShadoPan'),
(1795, 50602, 0, 'Nerozias'),
(1797, 400, 0, NULL),
(1817, 618, 0, NULL),
(1818, 5034, 0, NULL),
(1819, 5034, 0, NULL),
...
(1823, 5034, 0, NULL),
(1824, 5034, 0, NULL),
(1840, 50655, 0, 'Wandering Isle'),
(1841, 50655, 0, 'Wandering Isle'),
(1842, 50655, 0, 'Wandering Isle'),
(1843, 50655, 0, 'Wandering Isle'),
(1844, 50655, 0, 'Wandering Isle'),
(1845, 50655, 0, 'Wandering Isle'),
(1846, 50655, 0, 'Wandering Isle'),
(1847, 50655, 0, 'Wandering Isle'),
(1848, 50635, 0, 'Mogushan Vault'),
(1849, 5060, 0, 'Mogushan Palace'),
(1850, 50633, 0, 'Antorus'),
(1851, 50670, 0, 'QuaideFer'),
(1852, 50646, 0, 'TempleJadeSerpent'),
(1853, 5119, 0, 'PuisEternite'),
(1854, 50660, 0, 'CoeurPeur'),
(1855, 50629, 0, 'VaisseauLegion'),
(1856, 50657, 0, 'BrasserieBrumeOrage'),
(1857, 50658, 0, 'CimeVortex'),
(1858, 50659, 0, 'TempleNiuzao'),
(1859, 50653, 0, 'TerrassePrintaniere'),
(1860, 5126, 0, 'PalaisSacrenuit'),
(1861, 50688, 0, 'SalleValeureux'),
(1862, 5120, 0, 'OreeCiel'),
(1863, 50632, 0, 'Terre de Feu'),
(1864, 50690, 0, 'Jardin Hiver'),
(1865, 50601, 0, 'Nerozias'),
(1866, 5001, 0, 'Nerozias'),
(1867, 5125, 0, 'Krokuun'),
(1868, 50662, 0, 'DalaranLegion'),
(1869, 50654, 0, 'SejourCeleste'),
(1870, 5091, 0, 'SanctumOfLight'),
(1871, 5131, 0, 'HallGardien'),
(1872, 5132, 0, 'HaloNeant'),
(1873, 5133, 0, 'Maelstrom'),
(1874, 50680, 0, 'CheminReveEmeraude2'),
(1875, 1377, 0, 'ZoneDuel'),
(1878, 50707, 0, 'Ports Oubliés'),
(1879, 5449, 0, 'Gilneas BG - Graveyard (H-Mid)'),
(1880, 5449, 0, 'Gilneas BG - Graveyard (A-Mid)'),
(1881, 5449, 0, 'Gilneas BG - Graveyard (Mid)'),
(1882, 5449, 0, 'Gilneas BG - Graveyard (Horde Start)'),
(1883, 5449, 0, 'Gilneas BG - Graveyard (Alliance Start)'),
(1884, 5449, 0, 'Gilneas BG - Graveyard (Alliance Spawn)'),
(1885, 5449, 0, 'Gilneas BG - Graveyard (Horde Spawn)'),
(3552, 6051, 0, 'Valley of Power - BG - Graveyard - Alliance (Rectangle)'),
(3553, 6051, 0, 'Valley of Power - BG - Graveyard - Horde (Rectangle)'),
(3554, 6051, 0, 'Valley of Power - BG - Graveyard - Alliance (Circle)'),
(4057, 6051, 0, 'Valley of Power - BG - Graveyard - Horde (Rectangle) 2'),
(4058, 6051, 0, 'Valley of Power - BG - Graveyard - Alliance (Rectangle) 2'),
(4059, 6051, 0, 'Valley of Power - BG - Start - Alliance (Rectangle) Start'),
(4060, 6051, 0, 'Valley of Power - BG - Start - Horde (Rectangle) Start'),
(4135, 6296, 0, 'Tol\'vir Arena - PvP - Arena Graveyard'),
(4136, 6296, 0, 'Arena - Tol\'vir - Teleport Target - Team 1'),
(4137, 6296, 0, 'Arena - Tol\'vir - Teleport Target - Team 2'),
