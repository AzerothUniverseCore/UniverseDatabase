-- Export de la table `syphrena_string`
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS `syphrena_string`;
CREATE TABLE `syphrena_string` (
...
(196, 'There is no detailed usage information associated with \'%.*s\'.\nThis should never occur for stock TrinityCore commands - if it does, report this as a bug.\nIf this is a custom command, use `syphrena_string` to specify it. Look at cs_achievement.cpp for example usage.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(11100, 'Item transmogrified', NULL, 'Objet transmogrifié', NULL, NULL, NULL, NULL, NULL, NULL),
...
(11129, 'You don\'t have enough %ss', NULL, 'Vous n’avez pas assez de %ss', NULL, NULL, NULL, NULL, NULL, NULL),
