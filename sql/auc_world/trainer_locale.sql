-- Export de la table `trainer_locale`
SET NAMES utf8mb4;
...
CREATE TABLE `trainer_locale` (
  ...
  `Greeting_lang` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(386, 'frFR', 'Souhaitez-vous apprendre à voler ?', 15595),
(300049, 'frFR', 'Bonjour, Mage de combat sanglant ! Prêt à t\'entraîner ?', 0);
