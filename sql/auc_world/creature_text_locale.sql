...
(90100, 1, 0, 'frFR', 'Nous y voila. L\'amelioration de ton arme prodigieuse est juste devant nous. Au-revoir !'),
...
(624190, 10, 0, 'frFR', 'Allez bien jusqu\'au bout du donjon, votre hauts faits vous y attend.'),
(624190, 11, 0, 'frFR', 'Voilà, notre visite touche à sa fin. Bonne chance dans le donjon, aventurier. Au revoir !'),
(956655, 0, 0, 'frFR', 'Le Rivage Brisé ne pardonne aucune erreur. Restez groupés. La Légion nous observe depuis les cendres.'),
(956655, 1, 0, 'frFR', 'Suivez-moi, et gardez l\'arme haute. Ces terres calcinées ont déjà englouti des éclaireurs bien plus aguerris que nous.'),
(956655, 2, 0, 'frFR', 'Ces traces sont encore fraîches… Une créature démoniaque est passée par ici récemment. Gardez les yeux ouverts, elle pourrait ne pas être loin.'),
(956655, 3, 0, 'frFR', 'La crête, vite ! De là-haut, nous aurons enfin une vue dégagée sur les forces du Gangrefeu massées en contrebas.'),
(956655, 4, 0, 'frFR', 'La voilà… l’armée de la Légion. Tenez-vous prêts. À mon signal, nous frapperons d’un seul bloc.'),
(956655, 5, 0, 'frFR', 'Bien combattu. Reprenez votre souffle, mais ne baissez pas votre garde. Le rivage grouille encore de démons. Nous devons continuer.'),
(956655, 6, 0, 'frFR', 'Le combat marque une brève accalmie. Vous avez 2 minutes pour reprendre votre souffle et vous préparer… car le Rivage Brisé vous réserve encore de terribles épreuves.'),
(956655, 7, 0, 'frFR', 'À peine trente pas, et l’air empeste déjà le soufre. Ne relâchez rien. Quelque chose nous attend plus loin.'),
(956655, 8, 0, 'frFR', 'Ce sol porte les cicatrices de batailles livrées avant la nôtre. Regardez où vous posez les pieds et surveillez la lisière.'),
(956655, 9, 0, 'frFR', 'Bonne cadence. Mais restez vigilants. Les armées du Gangrefeu ne connaissent ni fatigue ni repos.'),
(956655, 10, 0, 'frFR', 'Nous sommes à mi-chemin. Continuons. Gardez l’œil ouvert, nous ne sommes certainement pas seuls.'),
(956655, 11, 0, 'frFR', 'L’air est saturé de magie démoniaque. Nous approchons de quelque chose que la Légion aurait préféré garder enfoui.'),
(956655, 12, 0, 'frFR', 'Là… derrière la crête. Ce qui nous attend n’est pas un simple serviteur de la Légion. Préparez-vous. À mon signal, nous l’abattons ensemble.'),
(956655, 13, 0, 'frFR', 'Il est à terre. Bien joué. Mais ne vous relâchez pas. Le rivage grouille encore de démons.'),
(956655, 14, 0, 'frFR', 'Plus loin… toujours plus loin. La Légion s’est profondément retranchée ici. Chaque pas que nous gagnons leur arrache du terrain.'),
(956655, 15, 0, 'frFR', 'Nous grimpons encore. Quoi que nous trouvions au sommet, il nous a probablement repérés depuis longtemps.'),
(956655, 16, 0, 'frFR', 'Là. Le voilà. Celui que nous sommes venus abattre… le commandant démoniaque de ce rivage.'),
(956655, 17, 0, 'frFR', 'Il ne nous a pas encore remarques. Cela ne durera pas.'),
(956655, 18, 0, 'frFR', 'Tout se joue maintenant. À mon signal… frappez de toutes vos forces !'),
(956655, 19, 0, 'frFR', 'C’est terminé. Le Rivage Brisé se souviendra de ce jour. Vous avez combattu avec courage et honneur. La Légion n’oubliera pas votre passage ici.'),
(957599, 0, 0, 'frFR', 'Le Rivage Brisé ne pardonne aucune erreur. Restez groupés. La Légion nous observe depuis les cendres.'),
(957599, 1, 0, 'frFR', 'Suivez-moi, et gardez l\'arme haute. Ces terres calcinées ont déjà englouti des éclaireurs bien plus aguerris que nous.'),
(957599, 2, 0, 'frFR', 'Ces traces sont encore fraîches… Une créature démoniaque est passée par ici récemment. Gardez les yeux ouverts, elle pourrait ne pas être loin.'),
(957599, 3, 0, 'frFR', 'La crête, vite ! De là-haut, nous aurons enfin une vue dégagée sur les forces du Gangrefeu massées en contrebas.'),
(957599, 4, 0, 'frFR', 'La voilà… l’armée de la Légion. Tenez-vous prêts. À mon signal, nous frapperons d’un seul bloc.'),
(957599, 5, 0, 'frFR', 'Bien combattu. Reprenez votre souffle, mais ne baissez pas votre garde. Le rivage grouille encore de démons. Nous devons continuer.'),
(957599, 6, 0, 'frFR', 'Le combat marque une brève accalmie. Vous avez 2 minutes pour reprendre votre souffle et vous préparer… car le Rivage Brisé vous réserve encore de terribles épreuves.'),
(957599, 7, 0, 'frFR', 'À peine trente pas, et l’air empeste déjà le soufre. Ne relâchez rien. Quelque chose nous attend plus loin.'),
(957599, 8, 0, 'frFR', 'Ce sol porte les cicatrices de batailles livrées avant la nôtre. Regardez où vous posez les pieds et surveillez la lisière.'),
(957599, 9, 0, 'frFR', 'Bonne cadence. Mais restez vigilants. Les armées du Gangrefeu ne connaissent ni fatigue ni repos.'),
(957599, 10, 0, 'frFR', 'Nous sommes à mi-chemin. Continuons. Gardez l’œil ouvert, nous ne sommes certainement pas seuls.'),
(957599, 11, 0, 'frFR', 'L’air est saturé de magie démoniaque. Nous approchons de quelque chose que la Légion aurait préféré garder enfoui.'),
(957599, 12, 0, 'frFR', 'Là… derrière la crête. Ce qui nous attend n’est pas un simple serviteur de la Légion. Préparez-vous. À mon signal, nous l’abattons ensemble.'),
(957599, 13, 0, 'frFR', 'Il est à terre. Bien joué. Mais ne vous relâchez pas. Le rivage grouille encore de démons.'),
(957599, 14, 0, 'frFR', 'Plus loin… toujours plus loin. La Légion s’est profondément retranchée ici. Chaque pas que nous gagnons leur arrache du terrain.'),
(957599, 15, 0, 'frFR', 'Nous grimpons encore. Quoi que nous trouvions au sommet, il nous a probablement repérés depuis longtemps.'),
(957599, 16, 0, 'frFR', 'Là. Le voilà. Celui que nous sommes venus abattre… le commandant démoniaque de ce rivage.'),
(957599, 17, 0, 'frFR', 'Il ne nous a pas encore remarques. Cela ne durera pas.'),
(957599, 18, 0, 'frFR', 'Tout se joue maintenant. À mon signal… frappez de toutes vos forces !'),
(957599, 19, 0, 'frFR', 'C’est terminé. Le Rivage Brisé se souviendra de ce jour. Vous avez combattu avec courage et honneur. La Légion n’oubliera pas votre passage ici.'),
(1075945, 0, 0, 'frFR', 'Par ici ! J\'ai un Sesame a distribuer, viens choisir ton metier ! Pense bien : une fois appris, il faudra te deconnecter puis te reconnecter pour qu\'il apparaisse dans ton grimoire.'),
(1173924, 0, 0, 'frFR', 'Restez près de moi. Ce vaisseau compte plus de fantômes que d\'équipage, et tous ne sont pas amicaux.'),
(1173924, 1, 0, 'frFR', 'Attention ici, le pont s\'est effondré quand nous avons pris ce vaisseau.'),
...
(1173924, 5, 0, 'frFR', 'La visite s\'arrête ici. Vous avez vu le vaisseau, allez maintenant montrer à la Légion ce que vous avez appris. Parlez à Jaedenar Legionnaire il vous conduira vers Netheril.'),
(1173927, 0, 0, 'frFR', 'Allons-y. Je vais vous faire visiter et ne vous éloignez pas, cette coque cache encore des surprises.'),
(1173927, 1, 0, 'frFR', 'Attention où vous marchez, cette section a presque englouti le vaisseau quand nous l\'avons pris d\'assaut.'),
...
(1173927, 5, 0, 'frFR', 'Voilà, la visite est terminée. Le reste du combat se joue là-bas, pas ici. Parlez à Jaedenar Legionnaire il vous conduira vers Netheril.'),
...
(2000512, 6, 0, 'frFR', 'Nous voici arrivés à Netheril. Prenez votre première quête, puis suivez-moi.'),
...
(2000512, 10, 0, 'frFR', 'Vous pouvez également récupérer vos équipements par ici pour la Horde.'),
...
(7007719, 0, 0, 'frFR', 'Ainsi, une âme de plus répond à l\'appel contre la Légion. Bienvenue à bord, champion. Ce vaisseau est tout ce qu\'il nous reste d\'une flotte arrachée aux griffes de la Légion. Parlez à Illidari Starr ou Illidari Kilbride ; l\'un comme l\'autre vous montrera ce que nous avons conquis, et ce qu\'il nous reste à affronter.');
