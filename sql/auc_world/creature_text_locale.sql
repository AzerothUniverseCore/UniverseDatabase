...
(956655, 0, 0, 'frFR', 'Le Rivage brise ne pardonne aucune hesitation. Restez groupes, la Legion nous observe depuis les cendres.'),
(956655, 1, 0, 'frFR', 'Suivez-moi, et gardez l\'arme haute. Ces champs de cendre ont deja englouti des eclaireurs bien plus aguerris que nous.'),
(956655, 2, 0, 'frFR', 'Vous sentez cette secousse ? Une bete demoniaque est passee par ici, et recemment. Restez sur vos gardes.'),
(956655, 3, 0, 'frFR', 'La crete, vite ! De la-haut, nous aurons enfin une ligne de vue sur les forces du Fel massees plus bas.'),
(956655, 4, 0, 'frFR', 'Voici l\'armee de la Legion. Donnez le mot, et nous chargeons comme un seul bataillon.'),
(956655, 5, 0, 'frFR', 'Bien combattu. Reprenez votre souffle, mais ce rivage grouille encore de demons. Nous devons avancer.'),
(956655, 6, 0, 'frFR', 'Ce troncon prend fin ici. Rechargez vos forces, la suite du Rivage brise nous reserve pire encore.'),
(956655, 7, 0, 'frFR', 'A peine trente pas, et l\'air empeste deja le soufre. Ne relachez rien.'),
(956655, 8, 0, 'frFR', 'Ce sol porte les cicatrices d\'autres batailles avant la notre. Surveillez vos appuis et la lisiere des arbres.'),
(956655, 9, 0, 'frFR', 'Bonne cadence, mais mefiez-vous. Les legions du Fel ne connaissent ni fatigue ni repos.'),
(956655, 10, 0, 'frFR', 'A mi-parcours, si ces cartes disent vrai. On continue, l\'oeil ouvert.'),
(956655, 11, 0, 'frFR', 'L\'air est sature de magie demoniaque. Nous approchons de quelque chose que la Legion preferait garder cache.'),
(956655, 12, 0, 'frFR', 'La, derriere la crete. Ce n\'est pas un simple suppot du Fel qui nous attend. Un mot, et nous l\'abattons ensemble.'),
(956655, 13, 0, 'frFR', 'Il est tombe. Bon travail, mais ce rivage grouille encore de demons. Restez vigilants.'),
(956655, 14, 0, 'frFR', 'Encore plus loin. La Legion s\'est retranchee profondement ici, chaque pas que nous gagnons leur coute cher.'),
(956655, 15, 0, 'frFR', 'Nous grimpons de nouveau. Quoi qu\'il y ait la-haut, il nous a probablement reperes depuis longtemps.'),
(956655, 16, 0, 'frFR', 'La. Voici celui que nous sommes venus abattre, le commandant demoniaque de ce rivage.'),
(956655, 17, 0, 'frFR', 'Il ne nous a pas encore remarques. Cela ne durera pas.'),
(956655, 18, 0, 'frFR', 'Tout se joue maintenant. A mon signal, nous frappons de toutes nos forces.'),
(956655, 19, 0, 'frFR', 'C\'est termine. Le Rivage brise se souviendra de ce jour. Vous avez tous combattu avec honneur.'),
(957599, 0, 0, 'frFR', 'Le Rivage brise ne pardonne aucune hesitation. Restez groupes, la Legion nous observe depuis les cendres.'),
(957599, 1, 0, 'frFR', 'Suivez-moi, et gardez l\'arme haute. Ces champs de cendre ont deja englouti des eclaireurs bien plus aguerris que nous.'),
(957599, 2, 0, 'frFR', 'Vous sentez cette secousse ? Une bete demoniaque est passee par ici, et recemment. Restez sur vos gardes.'),
(957599, 3, 0, 'frFR', 'La crete, vite ! De la-haut, nous aurons enfin une ligne de vue sur les forces du Fel massees plus bas.'),
(957599, 4, 0, 'frFR', 'Voici l\'armee de la Legion. Donnez le mot, et nous chargeons comme un seul bataillon.'),
(957599, 5, 0, 'frFR', 'Bien combattu. Reprenez votre souffle, mais ce rivage grouille encore de demons. Nous devons avancer.'),
(957599, 6, 0, 'frFR', 'Ce troncon prend fin ici. Rechargez vos forces, la suite du Rivage brise nous reserve pire encore.'),
(957599, 7, 0, 'frFR', 'A peine trente pas, et l\'air empeste deja le soufre. Ne relachez rien.'),
(957599, 8, 0, 'frFR', 'Ce sol porte les cicatrices d\'autres batailles avant la notre. Surveillez vos appuis et la lisiere des arbres.'),
(957599, 9, 0, 'frFR', 'Bonne cadence, mais mefiez-vous. Les legions du Fel ne connaissent ni fatigue ni repos.'),
(957599, 10, 0, 'frFR', 'A mi-parcours, si ces cartes disent vrai. On continue, l\'oeil ouvert.'),
(957599, 11, 0, 'frFR', 'L\'air est sature de magie demoniaque. Nous approchons de quelque chose que la Legion preferait garder cache.'),
(957599, 12, 0, 'frFR', 'La, derriere la crete. Ce n\'est pas un simple suppot du Fel qui nous attend. Un mot, et nous l\'abattons ensemble.'),
(957599, 13, 0, 'frFR', 'Il est tombe. Bon travail, mais ce rivage grouille encore de demons. Restez vigilants.'),
(957599, 14, 0, 'frFR', 'Encore plus loin. La Legion s\'est retranchee profondement ici, chaque pas que nous gagnons leur coute cher.'),
(957599, 15, 0, 'frFR', 'Nous grimpons de nouveau. Quoi qu\'il y ait la-haut, il nous a probablement reperes depuis longtemps.'),
(957599, 16, 0, 'frFR', 'La. Voici celui que nous sommes venus abattre, le commandant demoniaque de ce rivage.'),
