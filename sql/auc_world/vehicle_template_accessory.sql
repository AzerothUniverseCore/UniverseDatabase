-- Export de la table `vehicle_template_accessory`
SET NAMES utf8mb4;
...
(150305, 500095, 1, 1, 'Traveler Mammoth (A) - Vendor', 6, 30000),
(150305, 40924, 2, 1, 'Traveler Mammoth (A) - Vendor & Repairer', 6, 30000),
(339623, 33067, 7, 1, 'Salvaged Siege Engine', 6, 30000),
(339624, 33167, 1, 1, 'Salvaged Demolisher', 6, 30000),
(339624, 33620, 2, 1, 'Salvaged Demolisher - Earthen Stoneshaper', 6, 30000);
