...
CREATE TABLE `trainer` (
  ...
  `Greeting` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(127, 0, 5, 'Hello, priest!  Ready for some training?', 15211),
(386, 2, 0, 'Do you wish to learn how to fly?', 15595),
(60003, 0, 11, 'Hello, druid!  Ready for some training?', 0),
(150318, 0, 13, 'Hello, Demon Hunter!  Ready for some training?', 0),
(300049, 0, 10, 'Hello, Blood Battle Mage!  Ready for some training?', 0),
(312380, 1, 0, 'Hello!  Can I teach you something?', 0),
(338040, 2, 0, 'Would you like to learn the intricacies of recycler?', 0),
(381700, 0, 16, 'Hello, Heros!  Ready for some training?', 0);
