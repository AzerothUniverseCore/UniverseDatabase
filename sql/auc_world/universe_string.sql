-- Export de la table `universe_string`
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

DROP TABLE IF EXISTS `universe_string`;
CREATE TABLE `universe_string` (
  `entry` int(10) unsigned NOT NULL DEFAULT 0,
  `content_default` mediumtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `content_loc1` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc2` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc3` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc4` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc5` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc6` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc7` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_loc8` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`entry`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

INSERT INTO `universe_string` (`entry`, `content_default`, `content_loc1`, `content_loc2`, `content_loc3`, `content_loc4`, `content_loc5`, `content_loc6`, `content_loc7`, `content_loc8`) VALUES
...
(3, '[SERVER] %s', NULL, '|cffff0000[Message Système]: %s|r', NULL, NULL, NULL, NULL, NULL, NULL),
(4, '|cffff0000[Event Message]: %s|r', NULL, '|cffff0000[Annonce d\'événement]: %s|r', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'There is no help for that command', NULL, 'Aucune aide n\'est disponible pour cette commande.', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'Command \'%.*s\' does not exist', NULL, 'Cette commande n\'existe pas.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(12, 'Active connections: %u (max: %u) Queued connections: %u (max: %u)', NULL, 'Joueurs en ligne: %u (max: %u) Joueurs dans la file d\'attente: %u (max: %u)', NULL, NULL, NULL, NULL, NULL, NULL),
...
(16, 'The following GMs are active on this server:', NULL, 'Maître d\'Azeroth Universe disponibles:', NULL, NULL, NULL, NULL, NULL, NULL),
(17, 'There are no GMs currently logged in on this server.', NULL, 'Aucun Maître d\'Azeroth Universe n\'est actuellement connecté.', NULL, NULL, NULL, NULL, NULL, NULL),
(18, 'Cannot do that while flying.', NULL, 'Vous ne pouvez pas faire cela en vol.', NULL, NULL, NULL, NULL, NULL, NULL),
(19, 'Update time diff: %u.', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL),
(20, 'Time left until shutdown/restart: %s', NULL, 'Temps restant avant l\'arrêt/le redémarrage : %s', NULL, NULL, NULL, NULL, NULL, NULL),
(21, '%s\'s flying command failed.', NULL, '%s est en vol, la commande a échoué.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(105, 'You can only teleport to a player\'s instance if you are in their group, or you have MS mode enabled.', NULL, 'Vous ne pouvez vous téléporter dans l\'instance d\'un joueur que si vous êtes dans leur groupe ou si vous avez activé le mode MS.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(196, 'There is no detailed usage information associated with \'%.*s\'.\nThis should never occur for stock UniverseCore commands - if it does, report this as a bug.\nIf this is a custom command, use `universe_string` to specify it. Look at cs_achievement.cpp for example usage.', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(332, 'GM mode is ON', NULL, 'Le mode MS est activé', NULL, NULL, NULL, NULL, NULL, NULL),
(333, 'GM mode is OFF', NULL, 'Le mode MS est désactivé', NULL, NULL, NULL, NULL, NULL, NULL),
(334, 'GM Chat Badge is ON', NULL, 'Le badge MS Chat est activé', NULL, NULL, NULL, NULL, NULL, NULL),
(335, 'GM Chat Badge is OFF', NULL, 'Le badge MS Chat est désactivé', NULL, NULL, NULL, NULL, NULL, NULL),
...
(367, '### USAGE: .account set sec regmail <accountname> <email> <confirm email>\nReplaces the registration email on record for the specified account.', NULL, '### USAGE : .account set sec regmail <nom du compte> <email> <confirm email>\nRemplace l\'adresse électronique d\'enregistrement enregistrée pour le compte spécifié.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(388, '### USAGE: .learn all debug\nTeaches you a set of spells useful for testing raid encounters.\nYou shouldn\'t be using GM commands during testing - they can cause weird behavior on their own!', NULL, '### USAGE : .learn all debug\r\nVous enseigne un ensemble de sorts utiles pour tester les rencontres de raid.\r\nVous ne devriez pas utiliser les commandes MS pendant les tests - elles peuvent provoquer des comportements bizarres !', NULL, NULL, NULL, NULL, NULL, NULL),
...
(487, 'You learned default GM spells/skills.', NULL, 'Vous avez appris les sorts/compétences par défaut du MS.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(548, '│ GM Mode active, Phase: -1', NULL, '│ MS Mode active, Phase: -1', NULL, NULL, NULL, NULL, NULL, NULL),
...
(598, '|    Account    |  GM  |', NULL, '|    Compte    |  MS  |', NULL, NULL, NULL, NULL, NULL, NULL),
...
(714, '│ Account: %s (ID: %u), GMLevel: %u', NULL, '│ Compte: %s (ID: %u), MSLevel: %u', NULL, NULL, NULL, NULL, NULL, NULL),
...
(735, 'You must be in GM mode to teleport to a player in a battleground.', NULL, 'Vous devez être en mode MS pour vous téléporter vers un joueur sur un champ de bataille.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(1010, '-[         Account][   Character][             IP][Map][Zone][Exp][GMLev]-', NULL, '-[         Compte][   Personnage][             IP][Map][Zone][Exp][MSLev]-', NULL, NULL, NULL, NULL, NULL, NULL),
...
(1233, 'The Battle for Twin Peaks has begun!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(2016, 'Cannot close ticket %d, it is assigned to another GM.', NULL, 'Impossible de clôturer le ticket %d, il est assigné à un autre MS.', NULL, NULL, NULL, NULL, NULL, NULL),
...
(2023, '|cff00ff00GM Comment|r: [%s]|r', NULL, '|cff00ff00MS Comment|r: [%s]|r', NULL, NULL, NULL, NULL, NULL, NULL),
...
(6613, '|cfff00000[GM Announcement]: %s|r', NULL, '|cfff00000[MS Announcement]: %s|r', NULL, NULL, NULL, NULL, NULL, NULL),
(6614, 'Notification to GM\'s - ', NULL, 'Notifications des MS\'s - ', NULL, NULL, NULL, NULL, NULL, NULL),
(6615, '|cffffff00[|c1f40af20GM Announce by|r |cffff0000%s|cffffff00]:|r %s|r', NULL, '|cffffff00[|c1f40af20MS Annoncer par|r |cffff0000%s|cffffff00]:|r %s|r', NULL, NULL, NULL, NULL, NULL, NULL),
...
(11010, 'You didn\'t get kicked out of the instance even if Player::CheckInstanceLoginValid() returned false and without .gm on flag', NULL, 'Vous n\'avez pas été exclu de l\'instance même si Player::CheckInstanceLoginValid() a renvoyé un message faux et sans .ms on flag', NULL, NULL, NULL, NULL, NULL, NULL),
...
(12015, 'The Battle for Gilneas begins in 2 minutes.', NULL, 'La bataille pour Gilneas commence dans 2 minutes.', NULL, NULL, NULL, NULL, NULL, NULL),
(12016, 'The Battle for Gilneas begins in 1 minute.', NULL, 'La bataille pour Gilneas commence dans 1 minute.', NULL, NULL, NULL, NULL, NULL, NULL),
(12017, 'The Battle for Gilneas begins in 30 seconds. Prepare yourselves!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12018, 'The Battle for Gilneas has begun!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12019, 'Alliance', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12020, 'Horde', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12021, 'Lighthouse', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12022, 'Waterworks', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12023, 'Mine', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12024, 'The %s has taken the %s', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12025, '$N has defended the %s', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12026, '$N has assaulted the %s', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12027, '$N claims the %s! If left unchallenged, the %s will control it in 1 minute!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12028, 'The Alliance has gathered $6202W resources, and is near victory!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12029, 'The Horde has gathered $6203W resources, and is near victory!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
