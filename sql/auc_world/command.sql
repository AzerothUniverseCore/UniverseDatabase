...
CREATE TABLE `command` (
  ...
  `help` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='Chat System';
...
('ms chat', 'Syntax: .ms chat [on/off]\r\n\r\nEnable or disable chat GM MODE (show gm badge in messages) or show current state of on/off not provided.'),
('ms fly', 'Syntax: .ms fly [on/off]\r\nEnable/disable gm fly mode.'),
('ms ingame', 'Syntax: .ms ingame\r\n\r\nDisplay a list of available in game Game Masters.'),
('ms list', 'Syntax: .ms list\r\n\r\nDisplay a list of all Game Masters accounts and security levels.'),
('ms off', 'Syntax: .ms off\r\n\r\nDisables in-game GM mode.'),
...
('ms visible', 'Syntax: .ms visible on/off\r\n\r\nOutput current visibility state or make GM visible(on) and invisible(off) for other players.'),
